...
class Mi_perfil extends CI_Controller {
 ...
 function __construct() {
    ...
    public function busqueda_razon($rfc_busqueda, $tipo){
        ...
        $busqueda = "";//esta variable definira si busca por cliente o por rfc
        if ($tipo == 1) {
            $busqueda = "rfc";
        }
        else{
        ...
        //Al no poder recibir espacios por url se cambiaron por guiones bajos, ahora para la busqueda cambiamos los guiones bajos por espacio
...
//die('iteraciones: '.$k);
    ...
    public function registrar_datos_cuenta() {
        ...
        if ( $config_portal->usar_contrasena != CONTROL_ACCESO_SOLO_LOGIN_RFC ) {
            ...
            $id_pista_recuperar_contrasena   = null;
            $respuesta_recuperar_contrasena  = null;
        }
