...
class model_mis_comprobantes_pss extends CI_model {

  // listado de entidades segun el tipo de entidad ORGANIZATION, CUSTOMER, SUCURSAL, ETC
  public function buscar_comprobantes($id_usuario_pss, $tipo_usuario, $tipo_ejecucion, $where_id_clientes, $where_rfcs_emisor, $rfc_emisor, $nombre_emisor, $rfc_receptor, $nombre_receptor, $pais_residencia, $num_reg_id_trib, $serie, $folio_inicio, $folio_fin, $uuid, $fecha_emision_desde,
   $fecha_emision_hasta, $fecha_timbrado_desde, $fecha_timbrado_hasta, $moneda, $monto_desde, $monto_hasta, $tipo_comprobante, $concepto, $clave_prod_serv)
  {
      ...
      //$select_conteo  = " select count(*) as conteo from v_pss_listado_comprobantes_pss where ";
      $select_transaccion  = " select id_trx33, rfc_emisor, nombre_emisor, rfc_receptor, nombre_receptor, serie, folio, uuid, fecha_timbrado, moneda, total from v_pss_listado_comprobantes_autofactura where ";
      ...
      if ( $tipo_usuario == PERFIL_USUARIO_ADMON_STO || $tipo_usuario == PERFIL_USUARIO_ADMON_PORTAL || $tipo_usuario == PERFIL_USUARIO_OPERADOR ) {
          ...
          $clausulas = $where_id_clientes;
          $clausulas .= " and ".$where_rfcs_emisor;
      }
      ...
      if ( $pais_residencia != null && $pais_residencia != "---" ) {
          $like_pais_residencia = " and residencia_fiscal like '%".$pais_residencia."%'";
      ...
      if ( $fecha_emision_desde != null && $fecha_emision_desde != "" && $fecha_emision_hasta != null && $fecha_emision_hasta != "") {
          $like_fecha_emision = " and fecha between '".$fecha_emision_desde."' AND '".$fecha_emision_hasta."'";
      ...
      if ( $monto_desde != null && $monto_desde != "" && $monto_hasta != null && $monto_hasta != "") {
          $like_monto = " and total between ".$monto_desde." AND ".$monto_hasta;
    ...
    $busqueda_transaccion = $select_transaccion.$clausulas." and (uuid is not null or pdf is not null) order by fecha_timbrado DESC LIMIT 1000";
    ...
    if ( $tipo_ejecucion == 1 ) {
        ...
        foreach ( $result_transaccion->result() as $unaTransaccion)
        {
          ...
          $arr_transacciones[$num_transacciones] = array('id_trx33'          => $unaTransaccion->id_trx33         ,
