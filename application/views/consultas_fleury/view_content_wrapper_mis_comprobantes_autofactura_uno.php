         ...
         <div class="box">
            ...
            <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-md-1">
                    <label>S&oacutelo Activos</label><br><br>
                    <input type="checkbox" id="solo_activos" onclick="activos_on();" name="solo_activos" title="click para mostrar solo comprobantes activos." value="solo_activos">
                  </div>  
                  <div class="col-md-1">
                    <label>S&oacutelo Cancelados</label><br>
                    <input type="checkbox" id="solo_cancelados" onclick="cancelados_on();" name="solo_cancelados" title="click para mostrar solo comprobantes cancelados." value="solo_cancelados">
                  </div>
                  <!--div class="col-md-1">
                   <label>Tipo</label>
                  </div-->
...
?>
         ...
         <div class="box">
            <div class="box-header">
              ...
              <button class="btn btn-primary" type="button" name="merge_pdf" id="merge_pdf" title="Fusiona los archivos PDF de los comprobantes seleccionados" onclick="envia_xml('');" style="margin-left: 30px;"><i class="fa fa-envelope"></i> Enviar por correo</button>
            ...
            <div class="anexos_box-body">
                ...
                <div class="form-group">
                  ...
                  <table>
                      ...
                      $sql_anexos = 'SELECT id_anexo, nombre_anexo FROM v_emi_trx33_anexos WHERE id_trx33 ='.$comprobante->id_trx33;
                      $result_anexos = $this->db->query($sql_anexos);
                      $arr_anexos_clientes = $result_anexos->result();
