         ...
         <div class="box">
            <div class="box-header">
              ...
              if ( count($arrcomprobantes) > 0 ) {
                  echo '<a href="'.$url_envio_correo_masivo.'" class="btn btn-warning pull-right"><i class="fa fa-send-o"></i> Enviar o descargar todos</a>';
              }
              ?>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <form id="formulario_comprobantes" method="post" action="<?php echo $url_envio_descarga_comprobantes_salteados; ?>">
                <table id="listado_comprobantes" class="table table-striped table-condensed table-hover">
                  <thead>
                  <tr>
                    <th><label>Todos</label><input type="checkbox" name="all" id="all" onclick="seleccionar_todos(this)"></th>
                    <th>#</th>
                    <th>RFC emisor</th>
                    <th>Emisor</th>
                    <th>RFC Receptor</th>
                ...
                <input type="hidden" name="id_consulta" id="id_consulta_salteados" value="<?php echo $id_consulta; ?>">
              <input type="hidden" name="id_seleccionados" id="id_seleccionados" >                
                </form>
                <?php
                } // si hay registros
                ?>
