                ...
                <table id="listado_comprobantes" class="table table-striped table-condensed table-hover">
                  ...
                  if ( count($arrcomprobantes) > 0 ) {
                      ...
                      foreach ($arrcomprobantes as $comprobante) {
                          ...
                          $url_descarga_pdf_individual = "envia_pdf(".$comprobante->id_docto.");";
                          ...
                          echo '  <td><a href="'.$url_descarga_xml_individual.'" title="Descargar XML"><i class="fa fa-file-code-o"></i> </a> <a href="javascript:void(0)" onclick="'.$url_envio_correo_individual.'" title="Enviar por email"><i class="fa fa-envelope"></i> </a></td>';
                          echo '</tr>';
