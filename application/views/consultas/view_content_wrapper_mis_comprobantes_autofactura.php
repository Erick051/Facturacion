                      ...
                      foreach ($arr_anexos_clientes as $arr_anexos) {
                          ...
                          <tr>
                            ...
                            <td style="width: 100px;width: 10%">
                                <a class="btn fa fa-download" id="descargar_archivo_anexo" title='Descargar anexo' <a href="<?php echo $url_descarga_anexo; ?>"></a>
                            </td>
                          </tr>
              ...
              <?php
                ...
                <table class="table table-stripped table-hover table-condensed">
                  <tr>
                    ...
                    <th colspan="2" class="pull-right"><?php echo number_format(round($monto_total_facturas,2),2); ?></th>
                  </tr>
                </table>
                <?php
                } // si hay registros
