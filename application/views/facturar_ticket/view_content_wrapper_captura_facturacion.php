                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="<?php echo $campo->campo_adicional; ?>" id="<?php echo $campo->campo_adicional; ?>" placeholder="<?php echo $campo->placeholder; ?>" required>
                        </div>
