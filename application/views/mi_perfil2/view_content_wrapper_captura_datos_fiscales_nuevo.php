              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <input type="text" id="rfc" name="rfc" class="form-control" maxlength="13" value="" style="text-transform:uppercase;" required>
                    </div>
                    <div class="col-md-2">
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <input type="text" id="email_confirma" name="email_confirma" class="form-control" value="" required>
                    </div>
                  </div>
                </div>
