          ...
          <div class="box box-primary">
            ...
            <form role="form" class="form" method="post" action="#">
              <div class="box-body">
                ...
                <br>
                <label>Buscar razón social por RFC: </label>
                <input style="text-transform:uppercase;" maxlength="13" type="text" placeholder="RFC" name="busqueda_razon" id="busqueda_razon" value="">
                <input type="button" name="busca_Rfc" id="busca_Rfc" value="Buscar" onclick = "search_rfc()">
                ...
                <script type="text/javascript">
                  function search_rfc(){
                    if(document.getElementById('busqueda_razon').value!=''){
                      var str = document.getElementById('busqueda_razon').value;
                      var rfc = str.replace(/,/g,'');
                    //alert(rfc);
                    location.href ='<?php echo $url_busqueda_razon; ?>/'+rfc
                  }
                  else{
