            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-md-10">
                  ...
                  <h4>Relación de datos de cliente y usuario</h4>
                </div>
                <div class="col-md-2">
                  <a href="<?php echo $url_elegir_cliente; ?>" class="btn btn-warning pull-right"><i class="fa fa-plus"></i> Relacionar nuevo</a>
                </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <table class="table table-hover table-condensed">
                  ...
                  <?php
                  $conteo = count($arr_clientes);
                  if ( $conteo < 1 ) {
                      echo '<tr><td colspan="4">No se tienen registros de cliente relacionados para este usuario</td></tr>';
                  } else {
                      for ($i = 1; $i <= $conteo; $i++) {
                          // url para elminar la relacion cliente-usuario especifica
                          $url_eliminar_relacion_cliente_usuario_especifico = $url_eliminar_relacion_cliente_usuario."/".$arr_clientes[$i]->id_cliente;
                          
                          echo '<tr>';
                          echo '<td>'.$arr_clientes[$i]->id_cliente.'</td>';
                          echo '<td>'.$arr_clientes[$i]->numero_cliente.'</td>';
                          echo '<td>'.$arr_clientes[$i]->rfc.'</td>';
                          echo '<td>'.$arr_clientes[$i]->cliente.'</td>';
                          echo '<td><a href="'.$url_eliminar_relacion_cliente_usuario_especifico.'" class="text-danger" title="Eliminar relación"><i class="fa fa-times"></i></a></td>';
                          echo '</tr>';
                      }
                  }
