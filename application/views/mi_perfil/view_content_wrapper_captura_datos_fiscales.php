                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-md-11" id="div_colonia">
                      <input type="text" id="colonia" name="colonia" class="form-control" value="<?php echo str_replace('0', '', $cliente->colonia); ?>" />
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-md-5" id="div_municipio">
                      <input type="text" id="municipio" name="municipio" class="form-control" value="<?php echo str_replace('0', '', $cliente->municipio); ?>" />
                    </div>
                    <div class="col-md-1">
                      <label>Localidad</label>
                    </div>
                    <div class="col-md-5" id="div_localidad">
                      <input type="text" id="localidad" name="localidad" class="form-control" value="<?php echo str_replace('0', '', $cliente->municipio); ?>" />
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-md-2" id="div_estado">
                      <input type="text" id="estado" name="estado" class="form-control" value="<?php echo str_replace('0', '', $cliente->estado); ?>" />
                    </div>
                    <div class="col-md-1">
                      <label>País</label>
                    </div>
                    <div class="col-md-2">
                      <input type="text" id="pais" name="pais" class="form-control" value="<?php echo str_replace('0', '', $cliente->pais); ?>" />
                    </div>
                  </div>
                </div>
