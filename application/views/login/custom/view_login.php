...
<div class="login-box">
  ...
  <div class="login-box-body">
    <div class="row">
        <div class="col-md-12">
          <center>
            <img  class="img-responsive" width="250" src="<?php echo base_url()."assets_custom/imgcustom/logo_decathlon.png"; ?>"> 
          </center>
        </div>
        <div class="col-md-12 text-center">
            <h1><?php echo $config_portal->titulo_pantalla_principal; ?></h1>
        </div>
    </div>
    <p class="login-box-msg"><span id="aviso_login"><?php echo $config_portal->aviso_login; ?></span></p>
    <?php
    if ( isset($titulo) ) {
    ?>
    ...
    <form id="form_inicio_sesion" action="<?php echo $url_valida_inicio_sesion; ?>" method="post">
      <div class="form-group has-feedback">
        ...
        if ( $config_portal->usar_contrasena == CONTROL_ACCESO_SOLO_LOGIN_RFC ) {
            echo '<input type="text" id="login" name="login" class="form-control" placeholder="RFC">';
        } else {
