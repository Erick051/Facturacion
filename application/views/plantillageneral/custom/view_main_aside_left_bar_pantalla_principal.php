  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="<?php echo base_url()."index.php/".URL_MI_PERFIL; ?>"><i class="fa fa-smile-o"></i> <span>Mi perfil</span></a></li>
<?php
/*
  ...
  */?>
        ...
        if ( TIPO_PORTAL == TIPO_PORTAL_BOVEDA ) {
            ?>
            <li><a href="<?php echo base_url()."index.php/".URL_MIS_COMPROBANTES_BOVEDA; ?>"><i class="fa fa-list-alt"></i> <span>Consultar bóveda</span></a></li>
            <?php
        }
