  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Elige el RFC con el que deseas modificar</li>
      </ol>
    </section>
              ...
              <div class="box-body">
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <input style="text-transform:uppercase;margin-left: 54px" maxlength="13" type="text" name="busqueda_rfc" id="busqueda_rfc" value="" onclick="document.getElementById('busqueda_razon').value=''">
                    <br>
                    <label>Buscar por Razón Social:</label>
                    <input style="text-transform:uppercase;" type="text" name="busqueda_razon" id="busqueda_razon" value="" onclick="document.getElementById('busqueda_rfc').value=''">
                    <input type="button" name="busca_Rfc" id="busca_Rfc" value="Buscar" onclick = "busqueda_rfc_function(document.getElementById('busqueda_rfc').value)">
